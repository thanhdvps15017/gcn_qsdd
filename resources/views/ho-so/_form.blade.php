                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="loai_thu_tuc_id" class="form-select" id="thoi_han"
                                onchange="tinhHanTra(this)">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" name="han_giai_quyet" id="han_giai_quyet" class="form-control"
                                readonly
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <textarea name="ghi_chu" class="form-control" rows="2">{{ old('ghi_chu', $isEdit ? $hoSo->ghi_chu : '') }}</textarea>
                    </div>
        ...
        <div class="col-lg-6">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body row g-3">
                    <div class="col-md-4">
                        <label>Họ tên</label>
                        <input name="chu_su_dung[ho_ten]" class="form-control"
                            value="{{ $chuSuDung['ho_ten'] ?? '' }}">
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-12">
                        <label>Địa chỉ</label>
                        <textarea name="chu_su_dung[dia_chi]" rows="1" class="form-control">{{ $chuSuDung['dia_chi'] ?? '' }}</textarea>
                    </div>
        ...
        <div class="col-lg-6">
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <button type="button" class="btn btn-success btn-sm" onclick="addThua('tblThua')">+
                        Thêm</button>
                </div>
                <div class="card-body">
                            ...
                            <tbody id="tbl_nguoi_lien_quan">
                                ...
                                @foreach ($nguoiLienQuan as $idx => $nguoi)
                                    <tr>
                                        ...
                                        <td>
                                            <input
                                                name="thong_tin_rieng[data][nguoi_lien_quan][{{ $idx }}][cccd]"
    ...
    function addNguoiLienQuan(tbodyId) {
        ...
        const html = `
            <tr>
                ...
                <td><textarea name="thong_tin_rieng[data][nguoi_lien_quan][${i}][dia_chi]" class="form-control" rows="1" placeholder="Địa chỉ"></textarea></td>
                <td style="text-align: center;">
